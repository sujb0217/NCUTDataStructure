...
private:
    struct avlNode {
        ...
        avlNode() = default;
        avlNode(const T &elem) : element(elem), left(nullptr), right(nullptr), height(0) {}
        avlNode(const T &elem, avlNode* l, avlNode* r, int h) : element(elem), left(l), right(r), height(h) {}
    };
    avlNode* root;
